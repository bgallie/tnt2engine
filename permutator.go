...
var (
	...
	// There are 4 cycles they meet the following criteria:
...
func (p *Permutator) New(cycleSizes []int, randp []byte) *Permutator {
	...
	for i := range cycleSizes {
		...
		// Adjust the start to reflect the length of the previous cycles
...
// (pseudo-random) data generated by the TNT2 encryption algorithm
...
// Index returns the current index of the cryptor.  For permutators, this
// returns nil.
...
// length is not a multiple of 32 bytes to be correctly encrypted/decrypted.
